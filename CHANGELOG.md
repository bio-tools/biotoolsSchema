...
2. '''credit->orcidid''' pattern removed requirement for "http(s?)://orcid.org/" prefix (which isn't  part of the ORCID sytnax)  Regex is now [0-9]{4}-[0-9]{4}-[0-9]{4}-[0-9]{4}      *bio.tools* annotations will be refactored accordingly. 
