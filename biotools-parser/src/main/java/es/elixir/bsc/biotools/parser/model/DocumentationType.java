...
public enum DocumentationType {
    ...
    @XmlEnumValue("API documentation") API_DOCUMENTATION,
    @XmlEnumValue("Terms of use") TERMS_OF_USE,
    @XmlEnumValue("Citation instructions") CITATION_INSTRUCTIONS,
    @XmlEnumValue("Manual") MANUAL,
    @XmlEnumValue("Training material") TRAINING_MATERIAL,
    @XmlEnumValue("General") GENERAL,
