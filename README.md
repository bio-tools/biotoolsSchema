...
**Homepage** | Resource homepage | URL | y | y | y | `<homepage>`
...
**Scientific function** | The basic resource function(s), e.g. "Multiple sequence alignment" | Term and / or URI of [EDAM Operation](http://edamontology.org/operation_0004) concept(s) | y | y | y | `<function><operation>`
